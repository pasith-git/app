...
var RolesController = /** @class */ (function () {
    function RolesController(prisma, rolesService) {
        this.prisma = prisma;
        this.rolesService = rolesService;
    }
    RolesController.prototype.findById = function (req, res, id) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rolesService.findById(Number(id))];
                    case 1:
                        data = _a.sent();
    ...
    RolesController.prototype.findAll = function (req, res, _a) {
        var filter = _a.filter, query = __rest(_a, ["filter"]);
        return __awaiter(this, void 0, void 0, function () {
            var data_fixed, data_temp;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.rolesService.findAll()];
                    case 1:
                        data_fixed = _b.sent();
                        return [4 /*yield*/, this.rolesService.findAll(__assign({ filter: filter }, query))];
                    case 2:
                        data_temp = _b.sent();
    ...
    ], RolesController.prototype, "findById");
    __decorate([
        (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
        (0, role_decorator_1.Roles)(role_enum_1["default"].ADMIN, role_enum_1["default"].MANAGER, role_enum_1["default"].ACCOUNTANT, role_enum_1["default"].GUIDE, role_enum_1["default"].SUPERADMIN, role_enum_1["default"].OWNER),
        (0, common_1.Get)(""),
