...
var TestController = /** @class */ (function () {
    function TestController(googleService) {
        this.googleService = googleService;
    }
    TestController.prototype.test = function () {
        return __awaiter(this, void 0, void 0, function () {
            var oAuth2Client, url, res, tokenInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.googleService.getAuthenticatedClient()];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, oAuth2Client.getTokenInfo(oAuth2Client.credentials.access_token)];
                    case 3:
                        tokenInfo = _a.sent();
