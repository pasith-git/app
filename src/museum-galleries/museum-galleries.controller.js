...
exports.MuseumGalleriesController = void 0;
...
var museum_galley_schema_1 = require("common/schemas/museum-galley.schema");
...
var PREFIX = 'museum-galleries';
var MuseumGalleriesController = /** @class */ (function () {
    function MuseumGalleriesController(prisma, museumGalleriesService, authService, usersService) {
        this.prisma = prisma;
        this.museumGalleriesService = museumGalleriesService;
        this.authService = authService;
        this.usersService = usersService;
    }
    MuseumGalleriesController.prototype.findById = function (req, res, id) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.museumGalleriesService.findById(Number(id))];
                    case 1:
                        data = _a.sent();
    ...
    MuseumGalleriesController.prototype.findAll = function (req, res, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.museumGalleriesService.findAll(museum_id)];
                    case 1:
                        data_fixed = _d.sent();
                        return [4 /*yield*/, this.museumGalleriesService.findAll(museum_id, __assign({ filter: filter }, query))];
                    case 2:
                        data_temp = _d.sent();
    ...
    MuseumGalleriesController.prototype.createMany = function (req, res, createManyDto, files) {
        return __awaiter(this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_b) {
                                                    switch (_b.label) {
                                                        case 0:
                                                            ...
                                                            _a = {};
                                                            return [4 /*yield*/, this.museumGalleriesService.create(__assign(__assign({}, createDto), { image_path: createFile === null || createFile === void 0 ? void 0 : createFile.filePath }))];
    ...
    MuseumGalleriesController.prototype.updateMany = function (req, res, updateManyDto, files) {
        return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Promise.all(updateManyDto.map(function (updateDto, i) { return __awaiter(_this, void 0, void 0, function () {
                                                var museum_gallery, updateFile;
                                                var _a;
                                                return __generator(this, function (_b) {
                                                    switch (_b.label) {
                                                        case 0: return [4 /*yield*/, this.museumGalleriesService.findById(updateDto.id)];
                                                        case 1:
                                                            museum_gallery = _b.sent();
                                                            updateFile = (0, image_processor_util_1.updatefileGenerator)(files === null || files === void 0 ? void 0 : files[i], PREFIX, PREFIX, PREFIX, museum_gallery.image_path, updateDto.delete_image);
                                                            _a = {};
                                                            return [4 /*yield*/, this.museumGalleriesService.update(__assign(__assign({}, updateDto), { image_path: updateFile === null || updateFile === void 0 ? void 0 : updateFile.filePath }))];
    ...
    MuseumGalleriesController.prototype.deleteMany = function (req, res, deleteManyDto) {
        return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Promise.all(deleteManyDto.map(function (deleteDto, i) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_b) {
                                                    switch (_b.label) {
                                                        case 0: return [4 /*yield*/, this.museumGalleriesService.findById(deleteDto.id)];
                                                        case 1:
                                                            dataById = _b.sent();
                                                            deleteFile = (0, image_processor_util_1.deleteFileGenerator)(dataById.image_path);
                                                            _a = {};
                                                            return [4 /*yield*/, this.museumGalleriesService["delete"]({
                                                                    id: deleteDto.id
                                                                })];
                                                        case 2: return [2 /*return*/, (_a.data = _b.sent(),
    ...
    ], MuseumGalleriesController.prototype, "findById");
    __decorate([
    ...
    ], MuseumGalleriesController.prototype, "findAll");
    __decorate([
        (0, common_1.UseGuards)(auth_guard_1.AuthGuard, package_guard_1.PackageGuard, museumId_guard_1.MuseumIdGuard),
        ...
        __param(0, (0, common_1.Req)()),
        __param(1, (0, common_1.Res)()),
        __param(2, (0, common_1.Body)(new form_data_validation_pipe_1.FormDataValidationPipe(museum_galley_schema_1.createManyMuseumGallerySchema))),
        __param(3, (0, common_1.UploadedFiles)(new file_validation_pipe_1.FilesValidationPipe()))
    ], MuseumGalleriesController.prototype, "createMany");
    __decorate([
        (0, common_1.UseGuards)(auth_guard_1.AuthGuard, package_guard_1.PackageGuard, museumId_guard_1.MuseumIdGuard),
        (0, role_decorator_1.Roles)(role_enum_1["default"].ADMIN, role_enum_1["default"].MANAGER, role_enum_1["default"].SUPERADMIN, role_enum_1["default"].OWNER),
        (0, common_1.Put)(""),
        ...
        __param(0, (0, common_1.Req)()),
        __param(1, (0, common_1.Res)()),
        __param(2, (0, common_1.Body)(new form_data_validation_pipe_1.FormDataValidationPipe(museum_galley_schema_1.updateManyMuseumGallerySchema))),
        __param(3, (0, common_1.UploadedFiles)(new file_validation_pipe_1.FilesValidationPipe()))
    ], MuseumGalleriesController.prototype, "updateMany");
    __decorate([
        (0, common_1.UseGuards)(auth_guard_1.AuthGuard, package_guard_1.PackageGuard, museumId_guard_1.MuseumIdGuard),
        (0, role_decorator_1.Roles)(role_enum_1["default"].ADMIN, role_enum_1["default"].MANAGER, role_enum_1["default"].SUPERADMIN, role_enum_1["default"].OWNER),
        ...
        __param(0, (0, common_1.Req)()),
        __param(1, (0, common_1.Res)()),
        __param(2, (0, common_1.Body)(new joi_validation_pipe_1.JoiValidationPipe(museum_galley_schema_1.deleteManyMuseumGallerySchema)))
    ], MuseumGalleriesController.prototype, "deleteMany");
    MuseumGalleriesController = __decorate([
        (0, common_1.Controller)('museum-galleries')
    ], MuseumGalleriesController);
    return MuseumGalleriesController;
}());
exports.MuseumGalleriesController = MuseumGalleriesController;
