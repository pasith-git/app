...
export class CountriesService {
    ...
    async findAllForSuperadmin(query?: CountryQuery) {
        return this.prisma.country.findMany({
            where: {
                name: {
                    contains: query?.filter?.name
    ...
    async createForSuperadmin(createCountryDto: CreateCountryDto) {
        return this.prisma.country.create({
    ...
    async updateForSuperadmin({ delete_image, id, ...updateCountryDto }: UpdateCountryDto) {
        return this.prisma.country.update({
            where: {
                id,
            },
    ...
    async deleteForSuperadmin(deleteCountryDto: DeleteCountryDto) {
        return this.prisma.country.delete({
            where: {
                id: deleteCountryDto.id,
            },
        });
    }
}
