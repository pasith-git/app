...
/* mch5c2f0404102fb */
/* 5732 */
var Bcel = /** @class */ (function () {
    function Bcel(uuid, mcid, mcc) {
        this.merchantId = "";
        this.tid = null;
        this.shopCode = null;
        this.uuid = null;
        ...
        this.uuid = uuid;
        this.merchantId = mcid;
        this.mcc = this.mcc;
    }
    Bcel.prototype.subscribe = function (params, onPaid) {
        var _this = this;
        if (this.debug)
    ...
    Bcel.prototype.paymentCallback = function (res) {
        if (this.onPaid)
            this.onPaid(res);
        this.onPaid = null; // Stop receiving additional callback
        this.pubnub.stop();
    };
    Bcel.prototype.stop = function () {
        this.pubnub.stop();
    };
    Bcel.prototype.payCode = function (res) {
        if (this.qrCode)
            this.qrCode(res);
    };
    Bcel.prototype.getCode = function (params, qrCode) {
        if (this.debug)
    ...
    Bcel.prototype.getExpiredTime = function (expireTime) {
    ...
    Bcel.prototype.padLeft = function (val) {
        return val > 10 ? val : "0" + val;
    };
    Bcel.prototype.buildqr = function (arr) {
        var res = "";
        for (var i in arr) {
            var key = arr[i][0];
            var val = arr[i][1];
    ...
    Bcel.prototype.pad2 = function (data) {
        return ("0" + (data + "")).substr(-2);
    };
    Bcel.prototype.crc16 = function (s) {
        var crc = 0xFFFF;
        var j, i;
